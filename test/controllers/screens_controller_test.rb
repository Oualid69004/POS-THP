...
class ScreensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create screen" do
    assert_difference('Screen.count') do
      post screens_url, params: { screen: { isrout: @screen.isrout, name: @screen.name, parant: @screen.parant, url: @screen.url } }
    end
  ...
  test "should update screen" do
    patch screen_url(@screen), params: { screen: { isrout: @screen.isrout, name: @screen.name, parant: @screen.parant, url: @screen.url } }
